...
$(document).ready(function(){
    ...
    var auth_enter_window = $('#auth_form');
    
    auth_enter_btn_open.on('click', function(e){
        e.preventDefault();
        auth_enter_window.fadeIn(500);
    });
    
    auth_enter_btn_close.on('click', function(){
        auth_enter_window.fadeOut(500);
    });
